...
# By default all these toolchains are registered by the oak_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:oak_toolchain",
    toolchain_type = "@mgred_rules_oak//oak:toolchain_type",
)
""".format(
            platform = platform,
